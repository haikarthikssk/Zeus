...
$XS_pos = WinGetPos($hToast_Handle)
$XS_ret = DllCall("gdi32.dll", "long", "CreateRoundRectRgn", "long", 2, "long",2, "long", $XS_pos[2], "long", $XS_pos[3], "long", 10, "long", 10)
If $XS_ret[0] Then
  $XS_ret2 = DllCall("user32.dll", "long", "SetWindowRgn", "hwnd", $hToast_Handle, "long", $XS_ret[0], "int", 1)
EndIf
	If @error Then
		$nOldOpt = Opt('GUIOnEventMode', $nOldOpt)
		Return SetError(1, 0, -1)
